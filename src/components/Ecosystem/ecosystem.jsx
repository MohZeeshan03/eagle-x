               ...
               <div className="sl-container">
                    ...
                    <div className="space-y-4">
                         <div className="text-left">
                              <h3 className="text-sky-400 text-2xl font-medium mb-2">● Partnerships and Collaborations</h3>
                         ...
                         <div className="text-right">
                              <h3 className="text-sky-400 text-2xl font-medium mb-2">● Social Impact Reports and Metrics of Social Returns </h3>
                         ...
                         <div className="text-left">
                              <h3 className="text-sky-400 text-2xl font-medium mb-2">● Donations and Volunteering Opportunities</h3>
                         ...
                         <div className="text-right">
                              <h3 className="text-sky-400 text-2xl font-medium mb-2">● Events and Campaigns </h3>
                    ...
                    <p className="text-center mt-9">Our ecosystem is designed to foster collaboration, transparency, and active engagement. By being a part of the EAGLE-X community, you have the opportunity to make a real difference in the lives of others and contribute to sustainable social impact.</p>
               </div>
          </section>
     )
}