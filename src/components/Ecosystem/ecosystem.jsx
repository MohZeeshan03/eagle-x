     ...
     return (
          <section id="ecosystem" className="bg-center bg-no-repeat bg-fixed lg:py-24 md:py-16 py-10" style={{ backgroundImage: `url(${chartBg})` }}>
               <div className="sl-container">
                    <h2 className="font-semibold lg:text-5xl md:text-3xl text-2xl text-center tracking-wider lg:mb-6 sm:mb-4 mb-2">Eco<span className="text-sky-400">system</span></h2>
                    <p className="text-center lg:mb-12 md:mb-9 mb-6">Our ecosystem is built on the foundation of collaboration, impact measurement, and active community engagement. We believe in the power of partnerships, transparency in reporting, and the active involvement of individuals to drive meaningful change.</p>
                    ...
                    <p className="text-center lg:mt-9 md:mt-7 mt-5">Our ecosystem is designed to foster collaboration, transparency, and active engagement. By being a part of the EAGLE-X community, you have the opportunity to make a real difference in the lives of others and contribute to sustainable social impact.</p>
               </div>
          </section>
     )
}