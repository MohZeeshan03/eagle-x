          ...
          <section id="tokenomics" className="bg-gradient-to-b from-gray-950 to-gray-900">
               ...
               <div className="sl-container lg:py-20 md:py-14 py-9">
                    ...
                    <div className="wow fadeInDown flex items-center justify-between lg:mt-10 mt-4">
                         ...
                         <a href="/EagleX-Whitepaper.pdf" type="button" className="py-3 lg:px-10 px-6 border-2 border-sky-500 rounded-full uppercase font-semibold hover:border-sky-400 hover:text-sky-400 sl-animated-lg">DOWNLOAD WHITEPAPER</a>
                    </div>
               </div>
          </section>
     )
