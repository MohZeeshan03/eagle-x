     ...
     return (
          <section id="team" className="bg-gradient-to-b from-gray-900 to-gray-950 lg:py-24 md:py-16 py-10">
               <div className="sl-container">
                    <h2 className="wow fadeIn font-semibold lg:text-5xl md:text-3xl text-2xl text-center tracking-wider lg:mb-6 sm:mb-4 mb-2">Meet <span className="text-sky-400">Team</span></h2>
                    ...
                    <div className="flex flex-wrap">
                         <div className="wow zoomIn md:w-1/2 w-full px-4 text-center md:space-y-3 space-y-2 mb-6">
