...
export default function Footer() {
     ...
     return (
          <footer className="bg-gradient-to-b from-gray-900 to-gray-950 text-gray-400 text-base py-10">
               <div className="sl-container">
                    <div className="flex flex-wrap items-start py-14 border-t border-sky-200">
                         ...
                         <div className="w-1/4">
                              <h2 className="text-white text-xl uppercase font-semibold my-6">useful links</h2>
                         ...
                         <div className="w-1/4">
                              <h2 className="text-white text-xl uppercase font-semibold my-6">community</h2>
                              <ul className="space-y-2">
                         ...
                         <div className="w-1/4">
                              <h2 className="text-white text-xl uppercase font-semibold my-6">subscribe newsletter</h2>
                    ...
                    <div className="flex flex-wrap items-start justify-between pt-10 border-t border-gray-900">
                         <p className="">Copyright © 2023. All Rights Reserved <span className="text-white">Eagle X</span></p>
                         <ul className="flex flex-row flex-wrap space-x-6">
                              ...
                              <li><a href="" className="hover:text-sky-200 sl-animated-lg">Login / Signup</a></li>
                         </ul>
                    </div>
               </div>
          </footer>
